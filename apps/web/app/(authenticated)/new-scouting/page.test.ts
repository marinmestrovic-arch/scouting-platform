...
describe("new scouting page", () => {
  ...
  it("renders the new scouting workspace", () => {
    ...
    expect(html).toContain(
      "Start a scouting run with an exact run name, target, and prompt while campaign planning controls stay visible as disabled scaffolds for future backend support.",
    );
